...
TFIDF_PARQUET = "../outputs/tfidf_top30/dataset.parquet"

OUT_DIR = "../outputs/kmeans_tfidf_top30"
...
def main():
    ...
    spark = make_spark("arxiv-kmeans-tfidf-top30", driver_memory="12g")
    spark.conf.set("spark.sql.shuffle.partitions", "128")

    df = spark.read.parquet(TFIDF_PARQUET).select("id", "label_str", "features")
